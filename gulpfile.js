...
function watcher() {
	gulp.watch(path.watch.files, { usePolling: true }, gulp.series(copy))
	gulp.watch(path.watch.html, { usePolling: true }, gulp.series(html))
	gulp.watch(path.watch.scss, { usePolling: true }, gulp.series(scss))
	gulp.watch(path.watch.js, { usePolling: true }, gulp.series(js))
	gulp.watch(path.watch.images, { usePolling: true }, gulp.series(images))
}
